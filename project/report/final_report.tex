...
\begin{document}
	...
	achieve this, we basically used several public datasets, to create bilateral word associations between: countries, cities, nationalities, religions, religious affiliations and currencies. 
	\section{Methods}
	...
	\begin{figure}[htp]
	    \centering
	    \includegraphics[width=0.45\textwidth]{histsent.png}
	...
	\begin{figure}[htp]
	    \centering
	    \includegraphics[width=0.45\textwidth]{dailyavg.png}
	...
	\begin{thebibliography}{}
		...
		\bibitem[\protect\citename{Iglewicz}1993]{cite22}
		Boris Iglewicz and David Hoaglin.
		\newblock 1993.
		\newblock {\em The ASQC Basic References in Quality Control:
        Statistical Techniques}, volume~16.
